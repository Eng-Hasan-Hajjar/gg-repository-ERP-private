  ...
  <div class="dash-hero">
    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3">
      <div>
        ...
        <div class="dash-date">اليوم: <?php echo e(now()->locale('ar')->translatedFormat('l d F Y')); ?></div>
        <div class="dash-role">
  ...
  <?php if(auth()->user()?->hasPermission('view_dashboard')): ?>
    <div class="quick-stats">
      <div class="qs-card qs-warn">
        ...
        <div class="qs-text">
          <div class="qs-val"><?php echo e($highlights['alerts']['pending_leaves']); ?> إجازة •
            <?php echo e($highlights['alerts']['today_tasks']); ?> مهمة
          </div>
      ...
      <div class="qs-card qs-green">
        ...
        <div class="qs-text">
          <div class="qs-val"><?php echo e($todayStats['financial_transactions']); ?> حركة •
            <?php echo e(number_format($todayStats['financial_amount'], 0)); ?>
      ...
      <div class="qs-card qs-blue">
        ...
        <div class="qs-text">
          <div class="qs-val"><?php echo e($todayStats['new_students']); ?> جدد • <?php echo e($todayStats['confirmed_students']); ?> تثبيت</div>
      ...
      <div class="qs-card qs-purple">
        ...
        <div class="qs-text">
          <div class="qs-val"><?php echo e($highlights['activity']['count']); ?> تعديل •
            <?php echo e($highlights['activity']['last'] ? \Carbon\Carbon::parse($highlights['activity']['last'])->diffForHumans() : '—'); ?>
      ...
      <div class="col-12 col-md-6 col-xl-4">
        <div class="module-card">
          ...
          <div class="module-actions grid-2">
            ...
            <a href="<?php echo e(route('reports.task.index')); ?>" class="btn btn-soft w-100 w-sm-auto"><i
      ...
      <div class="col-12 col-md-6 col-xl-4">
        <div class="module-card">
          ...
          <div class="module-actions grid-2">
            ...
            <a href="<?php echo e(route('programs.management.index', ['type' => 'onsite'])); ?>" class="btn btn-soft w-100 w-sm-auto"><i
    ...
    <?php if(auth()->user()?->hasRole('super_admin')): ?>
      <div class="col-12 col-md-6 col-xl-4" hidden>
        <div class="module-card">
          ...
          <div class="module-actions grid-2">
            <a href="<?php echo e(route('system.backup.index')); ?>" class="btn btn-namaa w-100"><i class="bi bi-database"></i> النسخ
              الاحتياطية</a>
            <a href="<?php echo e(route('system.health')); ?>" class="btn btn-soft w-100"><i class="bi bi-activity"></i> حالة النظام</a>
          </div>
        </div>
      </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\engya\Desktop\namaa\laravel11-auth\resources\views\old.blade.php ENDPATH**/ ?>