...
<?php $__env->startPush('styles'); ?>
  <style>
    ...
    .col-toggle-btn:hover:not(.active) {
      background: #e2e8f0;
    }
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <tr class="<?php echo e($r->notes ? 'table-warning' : ''); ?>"
              ...
              <td class="col-branch hide-mobile"><?php echo e($r->employee->branch->name ?? '-'); ?></td>
              ...
              <td>
                <button class="btn btn-sm btn-outline-dark view-details" data-id="<?php echo e($r->id); ?>"
                  ...
                  data-day="<?php echo e($dayName); ?>" data-checkin="<?php echo e($r->check_in_at?->format('H:i')); ?>"
                  data-checkout="<?php echo e($r->check_out_at?->format('H:i')); ?>" data-break="<?php echo e($r->break_formatted); ?>"
                  data-late="<?php echo e($lateMin); ?>" data-worked="<?php echo e($workedHours); ?>" data-status="<?php echo e($r->status_label); ?>"
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <textarea id="notesField" class="form-control mt-2" rows="4" placeholder="اكتب ملاحظة إن وجدت..."></textarea>
          <hr>
