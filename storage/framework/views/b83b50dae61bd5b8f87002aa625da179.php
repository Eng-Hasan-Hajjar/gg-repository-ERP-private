...
<div class="row g-4 mt-1">
  ...
  <div class="col-md-3">
    <div class="module-card p-3">
      ...
      <p class="mb-1">اتصالات: <span id="db-connections"><?php echo e($db['connections']); ?></span> / <span id="db-max"><?php echo e($db['max_connections']); ?></span></p>
  ...
  <div class="col-md-3">
    <div class="module-card p-3">
      ...
      <p class="mb-0">PHP Memory: <span id="php-memory"><?php echo e($php['memory_usage_mb']); ?></span> MB / <?php echo e($php['memory_limit']); ?></p>
    </div>
  </div>
