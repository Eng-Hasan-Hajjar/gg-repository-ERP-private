    ...
    <div class="card-body">
        ...
        <div class="input-group mb-2">
            <input type="text" class="form-control" id="publicMediaLink"
                   value="<?php echo e(route('media.public.form')); ?>" readonly>
...
<div class="card shadow-sm">
    <div class="table-responsive">
        <table class="table align-middle mb-0">
            ...
            <tbody>
                <?php $__empty_0 = true; $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                <tr>
                    ...
                    <td class="hide-mobile">
                        <form method="POST" action="<?php echo e(route('media.update', $r)); ?>"
                            ...
                            <input type="text" name="content_link"
                                   value="<?php echo e($r->content_link); ?>"
                    ...
                    <td>
                        <button type="button"
                                ...
                                data-requester="<?php echo e($r->requester_name); ?>"
                                data-phone="<?php echo e($r->requester_phone ?? '—'); ?>"
                                data-diploma="<?php echo e($r->diploma_name ?? '—'); ?>"
                                data-code="<?php echo e($r->diploma_code ?? '—'); ?>"
                                data-trainer="<?php echo e($r->trainer_name ?? '—'); ?>"
                                ...
                                data-reviews-done="<?php echo e($r->reviews_done ? '1' : '0'); ?>"
