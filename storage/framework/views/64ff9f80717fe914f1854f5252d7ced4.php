        ...
        <form method="POST" action="<?php echo e(route('media.store')); ?>" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="requester_name" class="form-control" value="<?php echo e(old('requester_name')); ?>"
                        required>
                </div>

                <div class="col-md-6">
                    <label class="form-label">رقم الهاتف</label>
                    <input type="text" name="requester_phone" class="form-control" value="<?php echo e(old('requester_phone')); ?>">
                </div>
                
                <div class="col-md-6">
                    <label class="form-label">اسم الدبلومة <span class="text-danger">*</span></label>
                    <input type="text" name="diploma_name" class="form-control" value="<?php echo e(old('diploma_name')); ?>" required>
                </div>

                <div class="col-md-6">
                    <label class="form-label">ترميز الدبلومة <span class="text-danger">*</span></label>
                    <input type="text" name="diploma_code" class="form-control" value="<?php echo e(old('diploma_code')); ?>" required>
                </div>

                <div class="col-md-6">
                    <label class="form-label">اسم المدرب <span class="text-danger">*</span></label>
                    <input type="text" name="trainer_name" class="form-control" value="<?php echo e(old('trainer_name')); ?>" required>
                </div>

                <div class="col-md-6">
                    <label class="form-label">مكان تواجد المدرب <span class="text-danger">*</span></label>
                    <input type="text" name="trainer_location" class="form-control" value="<?php echo e(old('trainer_location')); ?>"
                        required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="diploma_location" class="form-control" value="<?php echo e(old('diploma_location')); ?>"
                        required>
                </div>
                ...
                <div class="col-md-6" hidden>
                    ...
                    <input type="date" name="editing_deadline" class="form-control" value="<?php echo e(old('editing_deadline')); ?>">
                </div>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6 mt-2">
                            <input type="text" name="need_other" class="form-control" placeholder="أخرى"
                                value="<?php echo e(old('need_other')); ?>">
                        </div>
                    </div>
                </div>
