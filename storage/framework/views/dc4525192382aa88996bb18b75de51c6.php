...
<?php if(isset($activeModule) && $activeModule === 'finance'): ?>
<style>
.namaa-fab-wrapper {
  position: fixed;
  bottom: 28px;
...
<div class="namaa-fab-panel" id="namaaFabPanel" role="dialog" aria-label="الصناديق المالية">
  ...
  <div class="namaa-fab-quick">
    <a href="<?php echo e(route('finance.dashboard')); ?>" class="namaa-fab-quick-btn">
      <svg viewBox="0 0 24 24"><path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/></svg>
      اللوحة
    </a>
    <a href="<?php echo e(route('finance.reports.daily')); ?>" class="namaa-fab-quick-btn">
    ...
    <a href="<?php echo e(route('finance.reports.profit')); ?>" class="namaa-fab-quick-btn">
    ...
    <a href="<?php echo e(route('cashboxes.create')); ?>" class="namaa-fab-quick-btn">
...
(function () {
  ...
  function loadCashboxes() {
    if (_loaded) return;
    fetch('<?php echo e(route("finance.fab.cashboxes")); ?>', {
...
<?php endif; ?><?php /**PATH C:\Users\engya\Desktop\customers\namaa\laravel11-auth\resources\views/finance/_fab.blade.php ENDPATH**/ ?>