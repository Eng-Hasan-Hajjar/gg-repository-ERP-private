...
<div class="quick-stats">
  <div class="qs-card qs-warn">
    ...
    <div class="qs-text">
      <div class="qs-val"><?php echo e($highlights['alerts']['pending_leaves']); ?> إجازة • <?php echo e($highlights['alerts']['today_tasks']); ?> مهمة</div>
  ...
  <div class="qs-card qs-green">
    ...
    <div class="qs-text">
      <div class="qs-val"><?php echo e($todayStats['financial_transactions']); ?> حركة • <?php echo e(number_format($todayStats['financial_amount'], 0)); ?></div>
  ...
  <div class="qs-card qs-purple">
    ...
    <div class="qs-text">
      <div class="qs-val"><?php echo e($highlights['activity']['count']); ?> تعديل • <?php echo e($highlights['activity']['last'] ? \Carbon\Carbon::parse($highlights['activity']['last'])->diffForHumans() : '—'); ?></div>
...
<div class="row g-3 g-lg-4 mb-4">
  ...
  <div class="col-12 col-md-6 col-xl-4" hidden>
    <div class="module-card">
      ...
      <div class="module-actions grid-2">
        <a href="<?php echo e(route('system.backup.index')); ?>" class="btn btn-namaa w-100"><i class="bi bi-database"></i> النسخ الاحتياطية</a>
