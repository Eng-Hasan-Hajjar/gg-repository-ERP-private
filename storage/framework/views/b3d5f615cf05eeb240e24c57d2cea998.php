...
<div class="row g-3">
  ...
  <div class="col-12 col-lg-6">
    ...
    <input name="name" class="form-control" required value="<?php echo e(old('name', $asset->name ?? '')); ?>">
  </div>
  ...
  <div class="col-12">
    ...
    <textarea name="description" class="form-control"
      rows="3"><?php echo e(old('description', $asset->description ?? '')); ?></textarea>
  </div>
  ...
  <div class="col-6 col-lg-3">
    ...
    <select name="condition" class="form-select" required>
      ...
      <option value="out_of_service" <?php if(old('condition', $asset->condition ?? '') == 'out_of_service'): echo 'selected'; endif; ?>>خارج الخدمة
      </option>
    </select>
  </div>
  ...
  <div class="col-6 col-lg-2">
    ...
    <input type="number" name="quantity" class="form-control" min="1" value="1"
      value="<?php echo e(old('quantity', $asset->quantity ?? 1)); ?>">
  ...
  <div class="col-6 col-lg-3">
    ...
    <select name="currency" class="form-select">
      <option value="USD" <?php echo e(old('currency', $asset->currency ?? 'USD') == 'USD' ? 'selected' : ''); ?>>دولار أمريكي (USD)
      </option>
      <option value="TRY" <?php echo e(old('currency', $asset->currency ?? 'USD') == 'TRY' ? 'selected' : ''); ?>>ليرة تركية (TRY)
      </option>
      <option value="EUR" <?php echo e(old('currency', $asset->currency ?? 'USD') == 'EUR' ? 'selected' : ''); ?>>يورو (EUR)</option>
      <option value="SYP" <?php echo e(old('currency', $asset->currency ?? 'USD') == 'SYP' ? 'selected' : ''); ?>>ليرة سورية (SYP)
      </option>
    </select>
  </div>
  ...
  <div class="col-12 col-lg-6">
    ...
    <input name="serial_number" class="form-control" value="<?php echo e(old('serial_number', $asset->serial_number ?? '')); ?>">
  </div>
  ...
  <div class="col-12">
    ...
    <?php if(isset($asset) && $asset->photo_path): ?>
      <div class="mt-2">
        <img src="<?php echo e(asset('storage/' . $asset->photo_path)); ?>" style="max-height:120px;border-radius:12px"
          class="border">
      </div>
    <?php endif; ?>
  </div>
