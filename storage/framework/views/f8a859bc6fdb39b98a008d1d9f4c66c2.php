...
<?php $__env->startSection('content'); ?>
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3 gap-2">
    ...
    <div class="d-flex gap-2 flex-wrap">
      ...
      <form method="POST" action="<?php echo e(route('admin.users.logoutAll')); ?>">
        <?php echo csrf_field(); ?>
          ...
          <tr>
            ...
            <td class="text-end">
              <div class="action-btn-group">
                ...
                <form method="POST" action="<?php echo e(route('admin.users.forceLogout', $u)); ?>" style="display:inline">
  ...
  <?php foreach ($users as $u): ?>
  <?php  if (!$u->hasRole('super_admin')): ?>
  <form id="del-<?= $u->id ?>" method="POST" action="<?php echo e(route('admin.users.destroy', $u)); ?>" style="display:none">
    <?php echo csrf_field(); ?>
