...
<div class="card shadow-sm p-4">
    <h5 class="fw-bold mb-3">
        <i class="bi bi-megaphone"></i> إرسال طلب لقسم الميديا
    </h5>

    <form method="POST" action="<?php echo e(route('media.public.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="requester_phone" class="form-control"
                       value="<?php echo e(old('requester_phone')); ?>" required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="trainer_location" class="form-control"
                       value="<?php echo e(old('trainer_location')); ?>" required>
            </div>
            ...
            <div class="col-12">
                <div class="form-check">
                    <input type="checkbox" name="trainer_photography_available"
                           ...
                           <?php echo e(old('trainer_photography_available') ? 'checked' : ''); ?>>
                    <label class="form-check-label" for="trainerPhoto">هل تصوير المدرب متاح؟</label>
                </div>
            </div>

            <div class="col-md-6">
                <label class="form-label">اعتمادية الشهادة <span class="text-danger">*</span></label>
                <input type="text" name="certificate_accreditation" class="form-control"
                       value="<?php echo e(old('certificate_accreditation')); ?>" required>
            </div>

            <div class="col-md-6">
                <label class="form-label">مسؤول خدمة العملاء <span class="text-danger">*</span></label>
                <input type="text" name="customer_service_responsible" class="form-control"
                       value="<?php echo e(old('customer_service_responsible')); ?>" required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="diploma_location" class="form-control"
                       value="<?php echo e(old('diploma_location')); ?>" required>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\engya\Desktop\namaa\laravel11-auth\resources\views\media\public_form.blade.php ENDPATH**/ ?>