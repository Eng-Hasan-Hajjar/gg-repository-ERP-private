...
<head>
  ...
  <title>خطأ في الخادم — Namaa ERP</title>
  ...
  <style>
    ...
    * { font-family: 'Hacen Tunisia', sans-serif !important; }
    body {
      ...
      background: radial-gradient(800px 500px at 20% 20%, rgba(245,158,11,.08), transparent 60%),
                  radial-gradient(800px 500px at 80% 80%, rgba(239,68,68,.08), transparent 60%),
    ...
    .error-icon-wrap {
      ...
      border: 2px solid rgba(245,158,11,.20); border-radius: 50%;
      display: flex; align-items: center; justify-content: center;
      margin: 0 auto 28px; font-size: 44px; color: #f59e0b;
    }
    .error-code {
...
<body>
  <div class="error-card">
    ...
    <h2>خطأ في الخادم</h2>
    <p>حدث خطأ غير متوقع في النظام.<br>تم تسجيل المشكلة وسيتم معالجتها قريباً.</p>
    ...
    <hr class="divider">
    <div class="help-text"><i class="bi bi-tools"></i> إذا استمرت المشكلة، تواصل مع الدعم التقني.</div>
  </div>
</body>
</html><?php /**PATH C:\Users\engya\Desktop\namaa\laravel11-auth\resources\views\errors\500.blade.php ENDPATH**/ ?>