...
<div class="desktop-only">
  <div style="background:#fff; border:1px solid rgba(226,232,240,.9); border-radius:16px; overflow:hidden;">
    <table class="exam-table">
      ...
      <tbody>
        <?php $__empty_0 = true; $__currentLoopData = $exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
          <tr>
            ...
            <td style="font-weight:700;" hidden><?php echo e($e->branch->name ?? '—'); ?></td>
