            ...
            <div class="modal-content border-0"
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="m-detail-box">
                                <div class="m-detail-label"><i class="bi bi-geo-alt-fill text-danger"></i> مكان التنفيذ
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="m-detail-box">
                                <div class="m-detail-label"><i class="bi bi-award-fill text-warning"></i> اعتمادية الشهادة
                                </div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="m-detail-box">
                                <div class="m-detail-label"><i class="bi bi-camera-fill text-secondary"></i> تصوير المدرب
                                </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6" id="mImageWrap" style="display:none;">
                            <div class="m-detail-box text-center">
                                ...
                                <img id="mImage" src="" class="rounded shadow-sm mt-2"
                                    style="max-width:180px; max-height:180px; object-fit:cover;">
                            </div>
                        </div>
                        <div class="col-md-6" id="mFileWrap" style="display:none;">
                            <div class="m-detail-box">
                                <div class="m-detail-label"><i class="bi bi-file-earmark-arrow-down text-success"></i> ملف
                                    التفاصيل</div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function confirmDelete(name, diploma) {
            return confirm(
