            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="content_category" class="form-select" required>
                        ...
                        <option value="invitation" <?php echo e(old('content_category') == 'invitation' ? 'selected' : ''); ?>>دعوة
                        </option>
                        ...
                        <option value="general_content" <?php echo e(old('content_category') == 'general_content' ? 'selected' : ''); ?>>
                            محتوى عام</option>
                    </select>
                </div>
...
<div class="col-md-4">
    ...
    <select name="branch" class="form-select">
        ...
        <?php $__currentLoopData = [
            ...
            <option value="<?php echo e($code); ?>" <?php if(old('branch') == $code): echo 'selected'; endif; ?>>
                <?php echo e($name); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" name="content_link" class="form-control" value="<?php echo e(old('content_link')); ?>"
                        placeholder="https://...">
                </div>
