...
<?php $__env->startSection('title','تعديل امتحان'); ?>
...
<div class="card border-0 shadow-sm">
  <div class="card-body">
    ...
    <form method="POST" action="<?php echo e(route('exams.update',$exam)); ?>">
      <?php echo method_field('PUT'); ?>
      <?php echo $__env->make('exams._form',['exam'=>$exam], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </form>
  </div>
</div>
