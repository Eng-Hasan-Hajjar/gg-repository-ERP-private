...
<div class="filters">
الفترة:
<?php echo e($data['filters']['from']); ?> → <?php echo e($data['filters']['to']); ?>
...
<td>
    ...
    <div class="kpi-value"><?php echo e($card['value']); ?></div>
</td>
...
<tbody>
<?php $__currentLoopData = $data['charts']['students_per_branch'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<tr>
    <td><?php echo e($row['branch']); ?></td>
    <td>
        <span class="badge success"><?php echo e($row['total']); ?></span>
    </td>
</tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</tbody>
...
<?php /**PATH C:\Users\engya\Desktop\namaa\laravel11-auth\resources\views/reports/pdf.blade.php ENDPATH**/ ?>