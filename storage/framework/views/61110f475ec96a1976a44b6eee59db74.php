      ...
      <form method="POST" action="<?php echo e(route('payment.plan.update', $plan->id)); ?>">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-4">
            ...
            <input type="number" step="0.01" name="total_amount" id="edit-total-amount" value="<?php echo e($plan->total_amount); ?>"
            ...
            <?php $__currentLoopData = $plan->installments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $installment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="row g-3 mt-2">
                <div class="col-md-6">
                  ...
                  <input type="number" step="0.01" min="0.01" name="installments[<?php echo e($i); ?>][amount]"
                    value="<?php echo e($installment->amount); ?>" class="form-control edit-installment-amount" required>
                ...
                <div class="col-md-6">
                  ...
                  <input type="date" name="installments[<?php echo e($i); ?>][due_date]" value="<?php echo e($installment->due_date); ?>"
                    class="form-control" required>
                </div>
              </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="text-end mt-4">
          ...
          <?php if($plan->lead_id): ?>
            <a href="<?php echo e(route('leads.show', $plan->lead_id)); ?>" class="btn btn-outline-secondary btn-pill">رجوع</a>
          <?php else: ?>
            <a href="<?php echo e(route('students.show', $plan->student_id)); ?>" class="btn btn-outline-secondary btn-pill">رجوع</a>
          <?php endif; ?>
        </div>
