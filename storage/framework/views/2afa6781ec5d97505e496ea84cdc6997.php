...
<div class="card border-0 shadow-sm">
  <div class="table-responsive">
    <table class="table align-middle mb-0">
      ...
      <tbody>
        <?php $__empty_0 = true; $__currentLoopData = $paginated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
          <tr>
            <td class="text-muted small hide-mobile"><?php echo e($paginated->firstItem() + $idx); ?></td>
            <td><code class="small hide-mobile"><?php echo e($d['university_id']); ?></code></td>
            <td class="fw-semibold"><?php echo e($d['name']); ?></td>
            <td class="small text-muted hide-mobile"><?php echo e($d['phone']); ?></td>
            <td class="text-center hide-mobile">
              <span class="badge bg-secondary rounded-pill"><?php echo e($d['diplomas_count']); ?></span>
            </td>
            <td class="text-center fw-bold hide-mobile hide-mobile"><?php echo e(number_format($d['total'], 2)); ?></td>
            <td class="text-center fw-bold text-primary hide-mobile"><?php echo e(number_format($d['paid'], 2)); ?></td>
