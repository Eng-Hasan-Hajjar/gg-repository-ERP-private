...
<head>
  ...
  <title>غير مصرح — Namaa ERP</title>
  ...
  <style>
    ...
    * { font-family: 'Hacen Tunisia', sans-serif !important; }
    ...
    body {
      ...
      background:
        radial-gradient(800px 500px at 20% 20%, rgba(239,68,68,.08), transparent 60%),
...
<body>
  <div class="error-card">
    ...
    <div class="help-text">
      ...
      إذا كنت تحتاج صلاحية معينة، تواصل مع مدير النظام لمنحك الوصول المناسب.
    </div>

  </div>
</body>
</html><?php /**PATH C:\Users\engya\Desktop\namaa\laravel11-auth\resources\views\errors\403.blade.php ENDPATH**/ ?>