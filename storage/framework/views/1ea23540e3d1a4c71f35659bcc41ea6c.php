      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
            ...
            <td><span class="badge bg-secondary"><?php echo e((int)$r->break_minutes); ?></span></td>
            <td class="fw-bold"><?php echo e(round($r->worked_minutes / 60, 2)); ?></td>
            <td><span class="badge bg-info text-dark"><?php echo e(round(max(0, $r->worked_minutes - $r->break_minutes) / 60, 2)); ?></span></td>
          </tr>
