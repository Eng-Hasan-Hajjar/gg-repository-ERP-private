          ...
          <div class="flex-grow-1">
            ...
            <div class="mt-2 d-flex flex-wrap gap-2">
              <?php if($student->is_confirmed): ?>
                <span class="badge-soft success">
                  ...
                  <span class="text-muted fw-bold">
                    (<?php echo e(optional($student->confirmed_at)->format('Y-m-d H:i')); ?>)
                  </span>
                </span>
              <?php else: ?>
              ...
              <span class="badge-soft">
                <i class="bi bi-diagram-3"></i> دبلومات: <?php echo e($student->diplomas->count()); ?>

              </span>

              <span class="badge-soft warn">
                <i class="bi bi-info-circle"></i> الحالة: <?php echo e($status_ar); ?>

              </span>

              <span class="badge-soft">
                <i class="bi bi-shield-check"></i>
                التسجيل: <?php echo e($registration_ar ?? '-'); ?>
  ...
  <div class="row g-3">
      ...
      <div class="glass-card h-100">
        ...
        <div class="p-3 p-md-4">
          <div class="kv">
            ...
            <div class="v"><?php echo e($student->first_name ?? '-'); ?></div>
          </div>
          <div class="kv">
            <div class="k">الكنية</div>
            <div class="v"><?php echo e($student->last_name ?? '-'); ?></div>
          </div>
          <div class="kv">
            <div class="k">الاسم والكنية</div>
            <div class="v"><?php echo e($student->full_name ?? '-'); ?></div>
          </div>
          <div class="kv">
            <div class="k">الهاتف</div>
            <div class="v"><?php echo e($student->phone ?? '-'); ?></div>
          </div>
          ...
          <div class="kv">
            ...
            <div class="v"><?php echo e($student->branch->name ?? '-'); ?></div>
          </div>
          <div class="kv">
            <div class="k">نوع الطالب</div>
            <div class="v"><?php echo e($mode_ar ?? '-'); ?></div>
          </div>
          <div class="kv">
            <div class="k">حالة الطالب</div>
            <div class="v"><?php echo e($status_ar ?? '-'); ?></div>
          </div>
          <div class="kv">
            <div class="k">حالة التسجيل</div>
            <div class="v"><?php echo e($registration_ar ?? '-'); ?></div>
          </div>
          <div class="kv">
            <div class="k">الرقم الجامعي</div>
            <div class="v"><code><?php echo e($student->university_id); ?></code></div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="p-3 p-md-4">
          ...
          <?php else: ?>
            <div class="kv">
              ...
              <div class="v"><?php echo e($student->crmInfo->first_contact_date?->format('Y-m-d') ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">السكن</div>
              <div class="v"><?php echo e($student->crmInfo->residence ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">العمر</div>
              <div class="v"><?php echo e($student->crmInfo->age ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">الجهة/المؤسسة</div>
              <div class="v"><?php echo e($student->crmInfo->organization ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">المصدر</div>
              <div class="v"><?php echo e($crm_source_ar ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">المرحلة</div>
              <div class="v"><?php echo e($crm_stage_ar ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">الإيميل</div>
              <div class="v"><?php echo e($student->crmInfo->email ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">العمل</div>
              <div class="v"><?php echo e($student->crmInfo->job ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">البلد</div>
              <div class="v"><?php echo e($student->crmInfo->country ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">المحافظة</div>
              <div class="v"><?php echo e($student->crmInfo->province ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">الدراسة</div>
              <div class="v"><?php echo e($student->crmInfo->study ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">مسؤول التواصل</div>
              <div class="v">
                <?php echo e($student->crmInfo->creator->name ?? $student->crmInfo->creator->email ?? '-'); ?>

              </div>
            </div>
            <div class="kv">
              <div class="k">الاحتياج</div>
              <div class="v"><?php echo e($student->crmInfo->need ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">ملاحظات CRM</div>
              <div class="v"><?php echo e($student->crmInfo->notes ?? '-'); ?></div>
            </div>
            <div class="kv">
              <div class="k">تاريخ التحويل</div>
              <div class="v"><?php echo e($student->crmInfo->converted_at?->format('Y-m-d H:i') ?? '-'); ?></div>
            </div>
          <?php endif; ?>
        </div>
      </div>
              ...
              <div class="glass-card h-100">
                <div class="p-3">
                  ...
                  <div class="kv">
                    ...
                    <div class="v"><?php echo e($p->arabic_full_name ?? '-'); ?></div>
                  </div>
                  <div class="kv">
                    <div class="k">الجنسية</div>
                    <div class="v"><?php echo e($p->nationality ?? '-'); ?></div>
                  </div>
                  <div class="kv">
                    <div class="k">تاريخ التولد</div>
                    <div class="v"><?php echo e($p->birth_date?->format('Y-m-d') ?? '-'); ?></div>
                  </div>
                  <div class="kv">
                    <div class="k">الرقم الوطني</div>
                    <div class="v"><?php echo e($p->national_id ?? '-'); ?></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="glass-card h-100">
                <div class="p-3">
                  ...
                  <div class="kv">
                    ...
                    <div class="v"><?php echo e($p->level ?? '-'); ?></div>
                  </div>
                  <div class="kv">
                    <div class="k">ستاج/مرحلة بالولاية</div>
                    <div class="v"><?php echo e($p->stage_in_state ?? '-'); ?></div>
                  </div>
                  <div class="kv">
                    <div class="k">المستوى التعليمي</div>
                    <div class="v"><?php echo e($p->education_level ?? '-'); ?></div>
                  </div>
                  <div class="kv">
                    <div class="k">العلامة الامتحانية</div>
                    <div class="v"><?php echo e($p->exam_score ?? '-'); ?></div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="row g-2 p-3">
                  ...
                  <div class="col-12 col-md-4">
                    <div class="kv">
                      ...
                      <div class="v">
                        <?php if(!empty($files['info']['exists']) && $files['info']['exists']): ?>
                          <span class="badge-soft success">
                            <i class="bi bi-check2-circle"></i> موجود
                          </span>
                          <div class="mt-2">
                            <a class="btn btn-outline-primary btn-sm" target="_blank" href="<?php echo e($files['info']['url']); ?>">
                  ...
                  <div class="col-12 col-md-4">
                    <div class="kv">
                      ...
                      <div class="v">
                        <?php if(!empty($files['identity']['exists']) && $files['identity']['exists']): ?>
                          <span class="badge-soft success">
                            <i class="bi bi-check2-circle"></i> موجود
                          </span>
                          <div class="mt-2">
                            <a class="btn btn-outline-dark btn-sm" target="_blank" href="<?php echo e($files['identity']['url']); ?>">
                  ...
                  <div class="col-12 col-md-4">
                    <div class="kv">
                      ...
                      <div class="v">
                        <?php if(!empty($files['attendance']['exists']) && $files['attendance']['exists']): ?>
                          <span class="badge-soft success">
                            <i class="bi bi-check2-circle"></i> موجودة
                          </span>
                          <div class="mt-2">
                            <a class="btn btn-outline-success btn-sm" target="_blank"
                              href="<?php echo e($files['attendance']['url']); ?>">
                  ...
                  <div class="col-12 col-md-4">
                    <div class="kv">
                      ...
                      <div class="v">
                        <?php if(!empty($files['certificate_pdf']['exists']) && $files['certificate_pdf']['exists']): ?>
                          <span class="badge-soft success">
                            <i class="bi bi-check2-circle"></i> موجودة
                          </span>
                          <div class="mt-2">
                            <a class="btn btn-outline-danger btn-sm" target="_blank"
                              href="<?php echo e($files['certificate_pdf']['url']); ?>">
                  ...
                  <div class="col-12 col-md-4">
                    <div class="kv">
                      ...
                      <div class="v">
                        <?php if(!empty($files['certificate_card']['exists']) && $files['certificate_card']['exists']): ?>
                          <span class="badge-soft success">
                            <i class="bi bi-check2-circle"></i> موجودة
                          </span>
                          <div class="mt-2">
                            <a class="btn btn-outline-primary btn-sm" target="_blank"
                              href="<?php echo e($files['certificate_card']['url']); ?>">
              ...
              <div class="col-12">
                <div class="glass-card mb-3 p-3">
                  ...
                  <div class="kv">
                    ...
                    <div class="v"><?php echo e($d->pivot->ended_at ?? '-'); ?></div>
                  </div>

                  <div class="kv">
                    <div class="k"> تسليم الشهادة كرنون </div>
                    <div class="v">
                      <?php echo e($d->pivot->certificate_delivered ? 'نعم' : 'لا'); ?>
                  ...
                  <div class="kv">
                    ...
                    <div class="v"><?php echo e($d->pivot->notes ?? '-'); ?></div>
                  </div>
            ...
            <div class="col-12">
              <div class="glass-card">
                <div class="p-3">
                  ...
                  <div class="kv">
                    <div class="k">ملاحظات</div>
                    <div class="v"><?php echo e($p->notes ?? '-'); ?></div>
                  </div>

                  <div class="kv">
                    <div class="k">رسالة لاحقة للطالب</div>
                    <div class="v"><?php echo e($p->message_to_send ?? '-'); ?></div>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge-soft hide-mobile">
                        <?php echo e($r->exam->diploma->name); ?>


                      </span>
                      <span class="text-muted">
                        (<?php echo e($r->exam->diploma->code); ?>)
                      </span>

                    </td>

                    <td class="text-muted hide-mobile">
                      <?php echo e(\Carbon\Carbon::parse($r->exam->exam_date)->format('Y-m-d')); ?>
    ...
    <div class="section-header">
      ...
      <div class="glass-card p-3">
        ...
        <form method="POST" action="<?php echo e(route('payment.plan.store')); ?>">
          <?php echo csrf_field(); ?>
...
<?php if(isset($plansByDiploma[$d->id])): ?>
    ...
    <?php else: ?>
        ...
        <a
        href="<?php echo e(route('payment.plan.edit',$plansByDiploma[$d->id]->id)); ?>"
        class="btn btn-warning btn-pill">
            ...
            <div class="col-md-6">
              ...
              <div class="glass-card p-3">
                ...
                <div class="kv">
                  ...
                  <div class="v">
                    <?php echo e(number_format($plan->total_amount, 2)); ?>
                ...
                <div class="kv">
                  ...
                  <div class="v">
                    <?php echo e($plan->payment_type == 'full' ? 'كامل' : 'دفعات'); ?>
                ...
                <div class="kv">
                  ...
                  <div class="v text-success">
                    <?php echo e(number_format($plan->paid, 2)); ?>
                ...
                <div class="kv">
                  ...
                  <div class="v text-warning">
                    <?php echo e(number_format(max($plan->remaining,0),2)); ?>
                ...
                <?php if($plan->installments->count()): ?>
                  ...
                  <?php $__currentLoopData = $plan->installments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="kv">
                      ...
                      <div class="k">
                        الدفعة <?php echo e($loop->iteration); ?>
                      ...
                      <div class="v">
                        ...
                        <span class="text-muted">
                          ...
                          (<?php echo e($i->due_date->format('Y-m-d')); ?>)
                ...
                <?php $__currentLoopData = $balancesByCurrency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="timeline-card text-center">
                      ...
                      <div
                        class="fs-4 fw-bold 
                                                                            <?php echo e($amount >= 0 ? 'text-success' : 'text-warning'); ?>">
                        <?php echo e(number_format($amount, 2)); ?>

                      </div>

                      <span class="badge-soft 
                                                                            <?php echo e($amount >= 0 ? 'success' : 'warn'); ?>">
                    ...
                    <div class="timeline-card">
                      ...
                      <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                        ...
                        <div>
                          ...
                          <div class="fw-bold">
                            <?php echo e($trx->type == 'in' ? 'دفعة مقبوضة' : 'دفعة مدفوعة'); ?>

                          </div>

                          <div class="small text-muted">
                            <?php echo e($trx->trx_date->format('Y-m-d')); ?>

                            —
                            <?php echo e($trx->cashbox->name ?? '-'); ?>

                            _
                              <?php if($trx->diploma): ?>
                                <br>
                                الدبلومة:
                                <span class="badge  text-light border" style="background-color: var(--namaa-green)"><?php echo e($trx->diploma->name); ?></span>
                        ...
                        <div class="text-end">
                          ...
                          <div
                            class="fw-bold fs-5 
                                                                                                    <?php echo e($trx->type == 'in' ? 'text-success' : 'text-warning'); ?>">
                            <?php echo e($trx->type == 'in' ? '+' : '-'); ?>
                          ...
                          <span
                            class="badge-soft 
                                                                                                    <?php echo e($trx->type == 'in' ? 'success' : 'warn'); ?>">
                ...
                <div class="col-md-4">
                  ...
                  <select name="cashbox_id" class="form-select" required>
                    <?php $__currentLoopData = \App\Models\Cashbox::where('status', 'active')
                      ...
                      <option value="<?php echo e($box->id); ?>">
