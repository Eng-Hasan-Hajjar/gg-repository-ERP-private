          ...
          <?php if(auth()->user()->hasRole('super_admin')): ?>
            ...
            <aside class="iconbar hide-mobile" aria-label="Module icons">
              <a href="<?php echo e(route('dashboard')); ?>"
                class="grad-indigo hide-mobile <?php echo e($activeModule === 'dashboard' ? 'active' : ''); ?>" data-title="لوحة التحكم">
              ...
              <?php if(auth()->user()?->hasPermission('manage_roles')): ?>
                ...
                <a href="<?php echo e(route('admin.audit.index')); ?>"
                  class="grad-rose hide-mobile <?php echo e($activeModule === 'audit' ? 'active' : ''); ?>" data-title="سجل التدقيق">
              ...
              <a href="<?php echo e(route('employees.index')); ?>"
                class="grad-primary hide-mobile <?php echo e($activeModule === 'employees' ? 'active' : ''); ?>"
              ...
              <a href="<?php echo e(route('cashboxes.index')); ?>"
                class="grad-amber  hide-mobile <?php echo e($activeModule === 'finance' ? 'active' : ''); ?>" data-title="المالية ">
              ...
              <a href="<?php echo e(route('attendance.index')); ?>"
                class="grad-rose hide-mobile <?php echo e($activeModule === 'attendance' ? 'active' : ''); ?>" data-title="الدوام">
                <i class="bi bi-calendar2-week fs-6"></i>
              </a>

              <a href="<?php echo e(route('tasks.index')); ?>"
                class="grad-slate hide-mobile <?php echo e($activeModule === 'tasks' ? 'active' : ''); ?>" data-title="المهام">
              ...
              <a href="<?php echo e(route('media.index')); ?>"
                class="grad-amber hide-mobile <?php echo e($activeModule === 'media' ? 'active' : ''); ?>" data-title="قسم الميديا">
              ...
              <?php if(auth()->user()?->hasPermission('manage_roles')): ?>
                <a href="<?php echo e(route('admin.settings.index')); ?>"
                  class="grad-slate <?php echo e($activeModule === 'settings' ? 'active' : ''); ?>" data-title="إعدادات النظام">
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', function () {
        ...
        showAllBtn.addEventListener('click', function (e) {
          ...
          // ✅ حمّل كل الإشعارات
          fetch('<?php echo e(route("alerts.navbar")); ?>?all=1', { credentials: 'same-origin' })
            .then(function (res) { return res.json(); })
            .then(function (data) {
              if (allContainer) {
