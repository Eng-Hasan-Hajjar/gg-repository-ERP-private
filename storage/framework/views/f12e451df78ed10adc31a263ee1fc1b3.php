...
<a href="<?php echo e(route('assets.print', $asset)); ?>" class="btn btn-outline-info rounded-pill fw-bold px-4" target="_blank">
    ...
    <div class="col-12 col-lg-5">
      <div class="card border-0 shadow-sm h-100">
        <div class="card-body">
          ...
          <?php if($asset->photo_path && \Illuminate\Support\Facades\Storage::disk('public')->exists($asset->photo_path)): ?>
            <img src="<?php echo e(asset('storage/app/public/' . $asset->photo_path)); ?>" class="img-fluid rounded"
