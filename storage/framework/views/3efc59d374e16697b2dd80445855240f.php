    ...
    <div class="d-flex flex-wrap gap-2 w-100 w-lg-auto justify-content-start justify-content-lg-end">
      ...
      <div class="dropdown d-sm-none w-100">
        ...
        <ul class="dropdown-menu w-100">
          ...
          <li>
            <a hidden class="dropdown-item" href="<?php echo e(route('attendance.calendar.exportPdf', request()->query())); ?>">
    ...
    <div class="calendar-wrap border">
      <div class="table-responsive" style="max-height:68vh;">
        <table class="table table-bordered align-middle mb-0 calendar-table">
          ...
          <tbody>
            <?php $__empty_0 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
              <tr>
                <td class="emp-col">
