...
<form class="card border-0 shadow-sm mb-3" method="GET">
  <div class="card-body">
    <div class="row g-2 align-items-end">
      ...
      <div class="col-12 col-md-2 d-grid">
        <a href="{{ route('employees.payouts.index',$employee) }}" class="btn btn-outline-secondary fw-bold">مسح الفلتر</a>
      </div>
    </div>
  </div>
</form>
  ...
  <div class="table-responsive">
    <table class="table align-middle mb-0">
      ...
      <tbody>
        ...
        @empty
          <tr><td colspan="8" class="text-center text-muted py-4">لا يوجد مستحقات</td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
