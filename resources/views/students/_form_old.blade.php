      ...
      <div class="card-body">
       ...
       <div class="col-12">
          <div class="d-flex align-items-center justify-content-between mb-1">
            <label class="form-label fw-bold mb-0">الرسالة التي سيتم ارسالها لاحقاً للطالب</label>
            <div class="d-flex gap-2">
              <button type="button" class="btn btn-sm btn-outline-primary" id="generateMessageBtn">
                <i class="bi bi-magic"></i> توليد تلقائي
              </button>
              <button type="button" class="btn btn-sm btn-outline-success" id="copyMessageBtn">
            ...
            @foreach($student->diplomas as $d)
              ...
              <div class="card p-3 mb-3 border">
                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-4">
                      <label>اتفاق الشهادة الممنوحة</label>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (generateBtn) {
    generateBtn.addEventListener('click', function () {
      ...
      // جمع الدبلومات المختارة
      var diplomaInputs = document.querySelectorAll('input[name="diploma_ids[]"]');
      var diplomaNames  = [];
      diplomaInputs.forEach(function (inp) {
        // البحث عن الاسم من الكارد المختار
        var name = inp.getAttribute('data-diploma-name') || inp.value;
        diplomaNames.push(name);
      });

      // جمع الدبلومات من الكاردات المعروضة
      var diplomaCards = document.querySelectorAll('.selected-diploma-card .sd-name');
      var diplomaList  = [];
      diplomaCards.forEach(function (el) {
        // إزالة badge "رئيسية" من النص
