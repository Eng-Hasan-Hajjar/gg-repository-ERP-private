        ...
        <div class="flex-grow-1">
          ...
          <div class="mt-2 d-flex flex-wrap gap-2">
            ...
            <span class="badge-soft">
              ...
              دبلومات: {{ $student->diplomas->count() }}
            </span>
...
<div class="row g-3">
  ...
  <div class="col-12 col-lg-6">
    <div class="glass-card h-100">
      <div class="p-3 p-md-4">
        ...
        <div class="kv"><div class="k">نوع الطالب</div><div class="v">{{ $student->mode ?? '-' }}</div></div>

        <div class="kv"><div class="k">حالة الطالب</div><div class="v">{{ $student->status ?? '-' }}</div></div>
        <div class="kv"><div class="k">حالة التسجيل</div><div class="v">{{ $student->registration_status ?? '-' }}</div></div>
      ...
      <div class="p-3 p-md-4">
        ...
        @if(!$student->crmInfo)
          <div class="alert alert-info mb-0 fw-semibold">
            <i class="bi bi-info-circle"></i>
            لا يوجد بيانات CRM لهذا الطالب.
          </div>
        @else
          ...
          <div class="kv"><div class="k">المصدر</div><div class="v">{{ $student->crmInfo->source ?? '-' }}</div></div>
          <div class="kv"><div class="k">المرحلة</div><div class="v">{{ $student->crmInfo->stage ?? '-' }}</div></div>
  ...
  <div class="col-12">
    <div class="glass-card">
      <div class="p-3 p-md-4">
        <h6 class="card-title mb-2">الملف التفصيلي للطالب (كامل)</h6>
        <div class="soft-divider"></div>

        @if(!$p)
          <div class="alert alert-warning mb-0 fw-semibold">
            <i class="bi bi-exclamation-triangle"></i>
            لا يوجد ملف تفصيلي لهذا الطالب بعد.
          </div>
        @else
                  ...
                  <div class="row g-2">
                          ...
                          @if($files['info']['exists'])
                            ...
                            <div class="mt-2">
                              <a class="btn btn-outline-primary btn-sm file-btn" target="_blank" href="{{ $files['info']['url'] }}">
                                <i class="bi bi-file-earmark-text"></i> فتح الملف
                              </a>
                            </div>
                          @else
                          ...
                          @if($files['identity']['exists'])
                            ...
                            <div class="mt-2">
                              <a class="btn btn-outline-dark btn-sm file-btn" target="_blank" href="{{ $files['identity']['url'] }}">
                                <i class="bi bi-person-badge"></i> فتح الهوية
                              </a>
                            </div>
                          @else
                            <span class="badge-soft gray"><i class="bi bi-x-circle"></i> غير موجود</span>
                          ...
                          @if($files['attendance']['exists'])
                            ...
                            <div class="mt-2">
                              <a class="btn btn-outline-success btn-sm file-btn" target="_blank" href="{{ $files['attendance']['url'] }}">
                                <i class="bi bi-file-earmark-check"></i> فتح الشهادة
                              </a>
                            </div>
                          @else
                    ...
                    <div class="col-12 col-md-4">
                      <div class="kv">
                        ...
                        <div class="v">
                          @if($files['certificate_card']['exists'])
                            <span class="badge-soft success"><i class="bi bi-check2-circle"></i> موجودة</span>
                            <div class="mt-2">
