        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="diploma_code" class="form-control"
                       value="{{ old('diploma_code') }}" required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="trainer_location" class="form-control"
                       value="{{ old('trainer_location') }}" required>
            </div>
            ...
            <div class="col-12">
                <div class="form-check">
                    <input type="checkbox" name="trainer_photography_available"
                           ...
                           {{ old('trainer_photography_available') ? 'checked' : '' }}>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="certificate_accreditation" class="form-control"
                       value="{{ old('certificate_accreditation') }}" required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="customer_service_responsible" class="form-control"
                       value="{{ old('customer_service_responsible') }}" required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="diploma_location" class="form-control"
                       value="{{ old('diploma_location') }}" required>
            </div>
