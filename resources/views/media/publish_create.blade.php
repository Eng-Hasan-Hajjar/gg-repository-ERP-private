            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="content_category" class="form-select" required>
                        ...
                        <option value="invitation" {{ old('content_category') == 'invitation' ? 'selected' : '' }}>دعوة
                        </option>
                        ...
                        <option value="general_content" {{ old('content_category') == 'general_content' ? 'selected' : '' }}>
                            محتوى عام</option>
                    </select>
                </div>
...
<div class="col-md-4">
    ...
    <select name="branch" class="form-select">
        ...
        @foreach([
            ...
            <option value="{{ $code }}" @selected(old('branch') == $code)>
                {{ $name }}
            </option>
        @endforeach
    </select>
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" name="content_link" class="form-control" value="{{ old('content_link') }}"
                        placeholder="https://...">
                </div>
