...
@section('content')
    ...
    <form method="GET" class="mb-3 d-flex gap-2">
        ...
        <a hidden href="{{ route('reports.attendance.monthly.pdf', ['month' => $month]) }}" class="btn btn-danger">
            تصدير PDF
        </a>

        <a href="{{ route('reports.attendance.monthly.excel', ['month' => $month]) }}" class="btn btn-success">
