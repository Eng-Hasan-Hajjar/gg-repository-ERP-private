              ...
              <td class="fw-semibold">
                ...
                <div class="user-cell">
                  ...
                  @if($u->isOnline())
                    ...
                    @endphp
                    @if($activeSession?->city || $activeSession?->country)
                      <div class="text-muted small">
                        <i class="bi bi-geo-alt-fill text-danger"></i>
                        {{ $activeSession->city }}{{ $activeSession->city && $activeSession->country ? '، ' : '' }}{{ $activeSession->country }}
                      </div>
                    @endif
                  @else
                    <span class="text-danger">غير متصل</span>
                    <div class="text-muted small">آخر ظهور: {{ $u->last_seen ?? '—' }}</div>
                  @endif
                </div>
