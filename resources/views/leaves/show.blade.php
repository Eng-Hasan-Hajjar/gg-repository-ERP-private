    ...
    <div class="card-body">
      <div class="row g-2">
        <div class="col-12 col-md-4"><b>الحالة:</b>
          <span
            class="badge bg-{{ $leave->status == 'approved' ? 'success' : ($leave->status == 'rejected' ? 'danger' : 'secondary') }}">
            {{ $leave->status }}
          </span>
        </div>
      ...
      @if($leave->status === 'pending')
        ...
        <div class="row g-2">
          <div class="col-12 col-lg-6">
            @if(auth()->user()?->hasPermission('approve_leaves'))
          ...
          <div class="col-12 col-lg-6">
            @if(auth()->user()?->hasPermission('reject_leaves'))
